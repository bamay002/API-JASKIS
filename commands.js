...
// 1. Update the reward for Polarwind to 10000
    db.bounties.updateOne( { reward: 4000 },
        { $set: { reward: 10000 } } )                   // feel like not best option ; confused on how to do it if there were two animals with same reward amount : how do i change just one
// 2. Remove Lokinkajou
